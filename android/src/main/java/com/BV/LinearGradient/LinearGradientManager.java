...
public class LinearGradientManager extends SimpleViewManager<LinearGradientView> {
    ...
    public static final String PROP_SET_TRANSPARENT = "transparent";
    public static final String PROP_SET_STROKE_WIDTH = "strokeWidth";
    ...
    @ReactProp(name = PROP_SET_TRANSPARENT)
    public void setIsTransparent(LinearGradientView gradientView, boolean transparent) {
        gradientView.setIsTransparent(transparent);
    }

    @ReactProp(name = PROP_SET_STROKE_WIDTH)
    public void setStrokeWidth(LinearGradientView gradientView, int strokeWidth) {
        gradientView.setStrokeWidth(strokeWidth);
    }
